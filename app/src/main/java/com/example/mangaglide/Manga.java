...
public class Manga extends Fragment {
    ...
    //final private String url = "https://1.bp.blogspot.com/-jCXa7Pq0kPc/W0xxuYab2MI/AAAAAAABLpY/Z7dlRUtOY-ExW8fDJCcS5wycwyG2nPyegCHMYCw/001.jpg?imgmax=16383";
    private String[] myUrls = new String[] {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerViewPreloader<Image> preloader = new RecyclerViewPreloader<>(Glide.with(this), modelProvider, sizeProvider, 20);
